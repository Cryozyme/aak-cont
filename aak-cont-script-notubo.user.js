...
if (a.domCmp(["altadefinizione.media"])) {
    ...
    a.ready(() => {
        a.$("a[href='https://web.archive.org/web/20180327090222/http://altarisoluzione.online/HD/play5.php']").remove();
    });
}
...
if (a.domCmp(["oddreaders.com"])) {
    ...
    a.onInsert((node) => {
        if (node.querySelector && node.querySelector("img[src='https://web.archive.org/web/20180327090222/http://oddreaders.com/wp-content/uploads/2017/07/" +
